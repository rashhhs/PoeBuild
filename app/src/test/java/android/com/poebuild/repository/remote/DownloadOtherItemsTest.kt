...
class DownloadOtherItemsTest {
    ...
    lateinit var download: DownloadOtherItems
    var countCalls = 0

    @Before
    fun setUp(){
        MockitoAnnotations.initMocks(this)
        download = DownloadOtherItems(service)
    }
    ...
    fun downloadPagination(){
        ...
        val single = Single.just(OtherItemQuery())
        whenever(service.getOtherItems(any(), any(), any())).thenReturn(single)

...
class DownloadSkillGemTest {
    ...
    lateinit var download: DownloadSkillGem
    var countCalls = 0

    @Before
    fun setUp(){
        MockitoAnnotations.initMocks(this)
        download = DownloadSkillGem(service)
    }
    ...
    fun downloadPagination(){
        ...
        val single = Single.just(SkillGemsQuery())
        whenever(service.getSkillGems(any(), any(), any())).thenReturn(single)

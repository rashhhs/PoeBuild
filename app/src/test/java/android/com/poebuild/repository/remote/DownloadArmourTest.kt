...
class DownloadArmourTest {
    ...
    lateinit var download: DownloadArmour
    var countCalls = 0

    @Before
    fun setUp(){
        MockitoAnnotations.initMocks(this)
        download = DownloadArmour(service)
    }
    ...
    fun downloadPagination(){
        ...
        val single = Single.just(ArmourQuery())
        whenever(service.getArmours(any(), any(), any())).thenReturn(single)

...
class DownloadWeaponTest {
    ...
    lateinit var download: DownloadWeapon
    var countCalls = 0

    @Before
    fun setUp(){
        MockitoAnnotations.initMocks(this)
        download = DownloadWeapon(service)
    }
    ...
    fun downloadPagination(){
        ...
        val single = Single.just(WeaponQuery())
        whenever(service.getWeapons(any(), any(), any())).thenReturn(single)
